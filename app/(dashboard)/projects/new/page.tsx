...
export default function NewProjectPage() {
  return (
    <div className="mx-auto max-w-3xl">
      <Link href="/projects" className="text-sm font-medium text-slate-500 hover:text-indigo-700">← Kembali ke project</Link>
