...
Status adalah salah satu dari `TODO`, `PROGRESS`, atau `DONE`. Ticket `DONE` selalu memiliki `Completion(note, completedAt)`; ticket yang dibuka kembali menyimpan alasan dalam `statusHistory` append-only.
